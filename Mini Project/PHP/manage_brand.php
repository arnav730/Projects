...
if($_SERVER['REQUEST_METHOD']=='POST')  {
                      ...
                      if($conn->connect_error)
                          ...
                          $did = $_POST['id'];
                 $sql ="DELETE FROM supplier_info WHERE s_name = '$did'";
                 $conn->query($sql);
                 echo $conn->error;
                //  if(!$results1)
                // {
                //   echo ("Could not delete rows");
                // }
...
<body>
  ...
  <h1 class="container"><div style="margin-left:400px;margin-bottom:50px;"> SUPPLIER </div></h1>
	<div class="container">
